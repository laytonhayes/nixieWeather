...
#define PASS        "[wifi password here]"                                 // WiFi Password
#define DEST_HOST   "api.wunderground.com"                           // API site host
#define DEST_IP     "23.222.155.203"                                 // API site IP address
#define API_CURRENT "/api/[API Key]/conditions/q/98122.json"  // Wunderground URL
#define API_FORCAST "/api/[API Key]/forecast/q/98122.json"
